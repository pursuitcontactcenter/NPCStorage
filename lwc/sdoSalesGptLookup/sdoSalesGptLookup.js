...
import getOneRecordById from '@salesforce/apex/SDO_SalesGptGenericLookup.getOneRecordById'
import getRecent from '@salesforce/apex/SDO_SalesGptGenericLookup.getRecent'
import getRecords from '@salesforce/apex/SDO_SalesGptGenericLookup.getRecords'
...
export default class SdoSalesGptLookup extends LightningElement {
    @track inputValue = ''
    @track records = []
    @track focused = false
    @track selected = ''
